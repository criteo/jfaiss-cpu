...
public class StopWordsInvertedLists extends ReadOnlyInvertedLists {
  ...
  public SWIGTYPE_p_long get_ids(long list_no) {
    long cPtr = swigfaissJNI.StopWordsInvertedLists_get_ids(swigCPtr, this, list_no);
  ...
  public void release_ids(long list_no, SWIGTYPE_p_long ids) {
    swigfaissJNI.StopWordsInvertedLists_release_ids(swigCPtr, this, list_no, SWIGTYPE_p_long.getCPtr(ids));
  }
  ...
  public void prefetch_lists(SWIGTYPE_p_long list_nos, int nlist) {
    swigfaissJNI.StopWordsInvertedLists_prefetch_lists(swigCPtr, this, SWIGTYPE_p_long.getCPtr(list_nos), nlist);
  }
